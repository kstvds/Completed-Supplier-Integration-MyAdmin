...
public class Amend_Credit {
	...
	Logger logger = Logger.getLogger("Amend_Credit");
	String SearchRateexpected;
	String errorpath;

	@Test
	@Parameters({ "browsername" })
	public void AmendCredit(String browsername) throws Exception {
		test = rep.startTest("Amend_Credit");
		...
		try {
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath() + "/Amend/Accommodation_Amend_Credit/Customer-Search.jpg");

		} catch (Throwable e) {
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Amend/Error/Accommodation_Amend_Credit/Customer-Search.jpg");
			test.log(LogStatus.FAIL, "Navigation to customer search page");
			errorpath = Config.SnapShotPath() + "/Amend/Error/Accommodation_Amend_Credit/Customer-Search.jpg";
			logger.info(e.getMessage());
			test.log(LogStatus.FAIL, e.getMessage());
			rep.endTest(test);
			rep.flush();
		...
		try {
			...
			obj.Takesnap(driverqa, Config.SnapShotPath() + "/Amend/Accommodation_Amend_Credit/Customer-list.jpg");
			...
			obj.Takesnap(driverqa, Config.SnapShotPath() + "/Amend/Error/Accommodation_Amend_Credit/Customer-list.jpg");
			test.log(LogStatus.FAIL, "Customer Selection");
			errorpath = Config.SnapShotPath() + "/Amend/Error/Accommodation_Amend_Credit/Customer-list.jpg";
			logger.info(e.getMessage());
			test.log(LogStatus.FAIL, e.getMessage());
			rep.endTest(test);
			rep.flush();
		...
		try {
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Amend/Accommodation_Amend_Credit/Search-Hotel-filters.jpg");
			...
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Amend/Accommodation_Amend_Credit/Booking-Channel-filters.jpg");
		...
		try {
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath() + "/Amend/Accommodation_Amend_Credit/Room-Selection.jpg");
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath() + "/Amend/Accommodation_Amend_Credit/booking-Details.jpg");
			...
			errorpath = Config.SnapShotPath() + "/Book/Error/Accommodation_Amend_Credit/Booking.jpg";
			logger.info(e.getMessage());
			test.log(LogStatus.FAIL, e.getMessage());
			rep.endTest(test);
			rep.flush();
		...
		try {
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath() + "/Amend/Accommodation_Amend_Credit/Amend-Page.jpg");
			...
			driverqa.findElement(Amend.newChckIn).sendKeys(excel.getData(0, 15, 1));

			driverqa.findElement(Amend.newChckOut).clear();
			driverqa.findElement(Amend.newChckOut).sendKeys(excel.getData(0, 15, 2));
			...
			String expectedLname1 = excel.getData(0, 25, 1);
			...
			/*
			 * String newIndate =
			 * driverqa.findElement(Amend.verifysupplierChkinCredit).getText();
			 * System.out.println(newIndate); Assert.assertEquals(newIndate,
			 * expectedchckIn);
			 * 
			 * System.out.println(newIndate);
			 * 
			 * String newOutdate =
			 * driverqa.findElement(Amend.verifysupplierChkoutCredit).getText();
			 * 
