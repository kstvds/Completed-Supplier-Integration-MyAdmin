	...
	public void AmendCreditWithinDeadLine(String browsername) throws Exception {
		...
		try {
			...
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Amend/Accommodation_Amend_Credit_Within_DeadLine/Log-In.jpg");

		} catch (Throwable e) {
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Amend/Error/Accommodation_Amend_Credit_Within_DeadLine/Log-In.jpg");
		...
		try {
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Amend/Accommodation_Amend_Credit_Within_DeadLine/Customer-Search.jpg");

		} catch (Throwable e) {
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Amend/Error/Accommodation_Amend_Credit_Within_DeadLine/Customer-Search.jpg");
		...
		try {
			...
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Amend/Accommodation_Amend_Credit_Within_DeadLine/Customer-list.jpg");
			...
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Amend/Error/Accommodation_Amend_Credit_Within_DeadLine/Customer-list.jpg");
		...
		try {
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Amend/Accommodation_Amend_Credit_Within_DeadLine/Search-Hotel-filters.jpg");
			...
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Amend/Accommodation_Amend_Credit_Within_DeadLine/Booking-Channel-filters.jpg");
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Amend/Accommodation_Amend_Credit_Within_DeadLine/Search-Result_Deadline.jpg");
			...
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Amend/Error/Accommodation_Amend_Credit_Within_DeadLine/Search-Result.jpg");
			errorpath = Config.SnapShotPath()
					+ "/Amend/Error/Accommodation_Amend_Credit_Within_DeadLine/Search-Result.jpg";
			logger.info(e.getMessage());
			test.log(LogStatus.FAIL, e.getMessage());
		...
		try {
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Amend/Accommodation_Amend_Credit_Within_DeadLine/Room-Selection.jpg");
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Amend/Accommodation_Amend_Credit_Within_DeadLine/Passenger-Details.jpg");
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Amend/Accommodation_Amend_Credit_Within_DeadLine/booking-Details.jpg");
			...
			String actualStartDate = driverqa.findElement(NewAccoBooking.thirdPartyafterbookCheckInCreditOutDead)
					.getText();
			System.out.println(actualStartDate);
			String expectedStartDate = excel.getData(0, 38, 1);
			String actualEndDate = driverqa.findElement(NewAccoBooking.thirdPartyafterbookCheckOutCreditOutDead)
					.getText();
			...
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Amend/Error/Accommodation_Amend_Credit_Within_DeadLine/Booking.jpg");
		...
		try {
			...
			Thread.sleep(3000);
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Amend/Accommodation_Amend_Credit_Within_DeadLine/AmendPage.jpg");
			driverqa.findElement(Amend.proceedAmend).click();
			wait.until(ExpectedConditions.visibilityOfElementLocated(Amend.confirmAmend));
			Thread.sleep(3000);
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Amend/Accommodation_Amend_Credit_Within_DeadLine/Confirm-AmendPage.jpg");
			...
			Thread.sleep(3000);
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Amend/Accommodation_Amend_Credit_Within_DeadLine/Procced-To-AmendPage.jpg");
			 ...
			 * System.out.println(expectedchckIn); String
			 * expectedchckOut=excel.getData(0, 34, 1);
			 */
			/*
			...
			/*
			 * String newIndate =
			 * driverqa.findElement(Amend.verifysupplierChkinPrePayafteramend).
			 * getText(); System.out.println(newIndate);
			 * Assert.assertEquals(newIndate, expectedchckIn);
			 * System.out.println(newIndate); String newOutdate =
			 * driverqa.findElement(Amend.verifysupplierChkoutPrePayafteramend).
			 * getText(); Assert.assertEquals(newOutdate, expectedchckOut);
			 * System.out.println(expectedchckOut);
			 */
			Thread.sleep(2000);
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Amend/Accommodation_Amend_Credit_Within_DeadLine/After-Amend.jpg");

		} catch (Throwable e) {
			test.log(LogStatus.FAIL, "Hotel Amend Credit Within DeadLine");
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Amend/Error/Accommodation_Amend_Credit_Within_DeadLine/Amending.jpg");
