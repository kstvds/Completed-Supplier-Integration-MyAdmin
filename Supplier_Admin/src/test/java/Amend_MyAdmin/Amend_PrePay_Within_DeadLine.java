...
public class Amend_PrePay_Within_DeadLine {
	...
	Logger logger = Logger.getLogger("Amend_PrePay_Within_DeadLine");
	...
	public void AmendPrepayWithinDeadLine(String browsername) throws Exception {
		...
		try {
			...
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Amend/Accommodation_Amend_Prepay_Within_DeadLine/Log-In.jpg");

		} catch (Throwable e) {
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Amend/Error/Accommodation_Amend_Prepay_Within_DeadLine/Log-In.jpg");
		...
		try {
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Amend/Accommodation_Amend_Prepay_Within_DeadLine/Customer-Search.jpg");

		} catch (Throwable e) {
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Amend/Error/Accommodation_Amend_Prepay_Within_DeadLine/Customer-Search.jpg");
		...
		try {
			...
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Amend/Accommodation_Amend_Prepay_Within_DeadLine/Customer-list.jpg");
			...
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Amend/Error/Accommodation_Amend_Prepay_Within_DeadLine/Customer-list.jpg");
		...
		try {
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Amend/Accommodation_Amend_Prepay_Within_DeadLine/Search-Hotel-filters.jpg");
			...
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Amend/Accommodation_Amend_Prepay_Within_DeadLine/Booking-Channel-filters.jpg");
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Amend/Accommodation_Amend_Prepay_Within_Deadline/Search-Result_Deadline.jpg");
			...
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Amend/Error/Accommodation_Amend_Prepay_Within_DeadLine/Search-Result.jpg");
			errorpath = Config.SnapShotPath()
					+ "/Amend/Error/Accommodation_Amend_Prepay_Within_DeadLine/Search-Result.jpg";
			logger.info(e.getMessage());
			test.log(LogStatus.FAIL, e.getMessage());
		...
		try {
			...
			wait.until(
					ExpectedConditions.visibilityOfElementLocated(NewAccoBooking.thirdPartyroomSelectionbookoutdead));
			driverqa.findElement(NewAccoBooking.thirdPartyroomSelectionbookoutdead).click();
			Thread.sleep(2000);
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Amend/Accommodation_Amend_Prepay_Within_DeadLine/Room-Selection.jpg");
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Amend/Accommodation_Amend_Prepay_Within_DeadLine/Passenger-Details.jpg");
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Amend/Accommodation_Amend_Prepay_Within_DeadLine/booking-Details.jpg");
			...
			String actualStartDate = driverqa.findElement(NewAccoBooking.thirdPartyafterbookCheckInPrepayOutDead)
					.getText();
			System.out.println(actualStartDate);
			String expectedStartDate = excel.getData(0, 38, 1);
			String actualEndDate = driverqa.findElement(NewAccoBooking.thirdPartyafterbookCheckOutPrepayOutDead)
					.getText();
			...
			test.log(LogStatus.INFO, "Ending HotelBook Prepay Within DeadLine");
			test.log(LogStatus.PASS, "PASSED HotelBook Prepay Within DeadLine");
			logger.info("Hotel Book Complete Prepay Within DeadLine");

		} catch (Throwable e) {
			test.log(LogStatus.FAIL, "Hotel Book Prepay Within DeadLine");
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Amend/Error/Accommodation_Amend_Prepay_Within_DeadLine/Booking.jpg");
			errorpath = Config.SnapShotPath() + "/Amend/Error/Accommodation_Amend_Prepay_Within_DeadLine/Booking.jpg";
			logger.info(e.getMessage());
			test.log(LogStatus.FAIL, e.getMessage());
			rep.endTest(test);
			rep.flush();
		...
		try {
			 ...
			 * driverqa.findElement(Amend.newFname).sendKeys(excel.getData(0,
			 * 24, 1)); driverqa.findElement(Amend.newFname2).clear();
			 * driverqa.findElement(Amend.newFname2).sendKeys(excel.getData(0,
			 * 25, 1)); driverqa.findElement(Amend.newLname).clear();
			 * driverqa.findElement(Amend.newLname).sendKeys(excel.getData(0,
			 * 24, 2)); test.log(LogStatus.PASS, "Changed name"); logger.info(
			 * "Changed name");
			 */
			...
			/*
			 * Select Adult = new
			 * Select(driverqa.findElement(Amend.ChangeNoOfAdults));
			 * Adult.selectByIndex(0); test.log(LogStatus.PASS,
			 * "Changed No Of Adult"); logger.info("Changed No Of Adult");
			 */
			Thread.sleep(3000);
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Amend/Accommodation_Amend_Prepay_Within_DeadLine/AmendPage.jpg");
			driverqa.findElement(Amend.proceedAmend).click();
			wait.until(ExpectedConditions.visibilityOfElementLocated(Amend.confirmAmend));
			Thread.sleep(3000);
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Amend/Accommodation_Amend_Prepay_Within_DeadLine/Confirm-AmendPage.jpg");
			...
			Thread.sleep(3000);
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Amend/Accommodation_Amend_Prepay_Within_DeadLine/Procced-To-AmendPage.jpg");
			...
			/*
			 * String expectedFname1=excel.getData(0, 24, 1); String
			 * expectedFname2=excel.getData(0, 25, 1); String
			 * expectedLname1=excel.getData(0, 24, 2);
			 */
			...
			// String newoccupancy =
			// driverqa.findElement(Amend.AfterAmendOccupancyPrePay).getText();
			...
			/*
			 * String newFname=
			 * driverqa.findElement(Amend.verifyfNamesupplierPrePay).getText();
			 * System.out.println(newFname); System.out.println(expectedFname1);
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Amend/Accommodation_Amend_Prepay_Within_DeadLine/After-Amend.jpg");

		} catch (Throwable e) {
			test.log(LogStatus.FAIL, "Hotel Amend Prepay Within DeadLine");
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Amend/Error/Accommodation_Amend_Prepay_Within_DeadLine/Amending.jpg");
			errorpath = Config.SnapShotPath() + "/Amend/Error/Accommodation_Amend_Prepay_Within_DeadLine/Amending.jpg";
			logger.info(e.getMessage());
			test.log(LogStatus.FAIL, e.getMessage());
			rep.endTest(test);
			rep.flush();
