...
public class Amend_Prepay_MultiSupplier {
	...
	Logger logger = Logger.getLogger("Amend_Prepay_MultiSupplier");
	...
	public void AmendPrepayMultiSupplier(String browsername) throws Exception {
		...
		try {
			...
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Amend/Accommodation_Amend_Prepay_MultiSupplier/Log-In.jpg");

		} catch (Throwable e) {
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Amend/Error/Accommodation_Amend_Prepay_MultiSupplier/Log-In.jpg");
			test.log(LogStatus.FAIL, "Login");
			errorpath = Config.SnapShotPath() + "/Amend/Error/Accommodation_Amend_Prepay_MultiSupplier/Log-In.jpg";
		...
		try {
			...
			Thread.sleep(3000);
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Amend/Accommodation_Amend_Prepay_MultiSupplier/Customer-Search.jpg");

		} catch (Throwable e) {
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Amend/Error/Accommodation_Amend_Prepay_MultiSupplier/Customer-Search.jpg");
		...
		try {
			...
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Amend/Accommodation_Amend_Prepay_MultiSupplier/Customer-list.jpg");
			...
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Amend/Error/Accommodation_Amend_Prepay_MultiSupplier/Customer-list.jpg");
			test.log(LogStatus.FAIL, "Customer Selection");
			errorpath = Config.SnapShotPath()
					+ "/Amend/Error/Accommodation_Amend_Prepay_MultiSupplier/Customer-list.jpg";
			logger.info(e.getMessage());
			test.log(LogStatus.FAIL, e.getMessage());
			rep.endTest(test);
			rep.flush();
		...
		logger.info("Starting HotelSearch Prepay for Supplier Room");
		try {
			test.log(LogStatus.INFO, "Starting HotelSearch Prepay for Supplier Room");
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Amend/Accommodation_Amend_Prepay_MultiSupplier/Search-Hotel-Supplier-filters.jpg");
			...
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Amend/Accommodation_Amend_Prepay_MultiSupplier/Booking-Channel-Supplier-filters.jpg");
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Amend/Accommodation_Amend_Prepay_MultiSupplier/Search-Result-Supplier.jpg");
			...
			logger.info("Hotel Search Complete Prepay for Supplier Room");
		} catch (Throwable e) {
			test.log(LogStatus.FAIL, "Hotel Search Prepay for Supplier Room");
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Book/Error/Accommodation_Book_Prepay_MultiSupplier/Search-Result-Supplier.jpg");
			errorpath = Config.SnapShotPath()
					+ "/Amend/Error/Accommodation_Amend_Prepay_MultiSupplier/Search-Result-Supplier.jpg";
			logger.info(e.getMessage());
			test.log(LogStatus.FAIL, e.getMessage());
			rep.endTest(test);
			rep.flush();
		...
		try {
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Amend/Accommodation_Amend_Prepay_MultiSupplier/Room-Selection-Supplier.jpg");
			wait.until(
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Amend/Accommodation_Amend_Prepay_MultiSupplier/Passenger-Details-Supplier.jpg");
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Amend/Accommodation_Amend_Prepay_MultiSupplier/Itenary-Details-Supplier.jpg");
			...
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Amend/Error/Accommodation_Amend_Prepay_MultiSupplier/Save-Itenary-Supplier.jpg");
			errorpath = Config.SnapShotPath()
					+ "/Amend/Error/Accommodation_Amend_Prepay_MultiSupplier/Save-Itenary-Supplier.jpg";
			logger.info(e.getMessage());
			test.log(LogStatus.FAIL, e.getMessage());
		...
		try {
			...
			logger.info("Starting HotelSearch Prepay for DOTW Room");
			test.log(LogStatus.INFO, "Starting HotelSearch Prepay for DOTW Room");
			wait.until(ExpectedConditions.visibilityOfElementLocated(NewAccoBooking.AccomUnit));
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Amend/Accommodation_Amend_Prepay_MultiSupplier/Search-Hotel-filters-DOTW.jpg");
			wait.until(ExpectedConditions.visibilityOfElementLocated(NewAccoBooking.bookChannel));
			driverqa.findElement(NewAccoBooking.bookChannel).click();
			...
			wait.until(ExpectedConditions.visibilityOfElementLocated(NewAccoBooking.searchButton));
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Amend/Accommodation_Amend_Prepay_MultiSupplier/Booking-Channel-filters-DOTW.jpg");
			driverqa.findElement(NewAccoBooking.searchButton).click();
			wait.until(ExpectedConditions.visibilityOfElementLocated(NewAccoBooking.thirdPartyresultHotel));
			String result = driverqa.findElement(NewAccoBooking.thirdPartyresultHotel).getText();
			Thread.sleep(2000);
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Amend/Accommodation_Amend_Prepay_MultiSupplier/Search-Result-DOTW.jpg");
			Assert.assertTrue(result.contains(expected));
			...
			logger.info("Hotel Search Complete Prepay for DOTW Room");
		} catch (Throwable e) {
			test.log(LogStatus.FAIL, "Hotel Search Prepay for DOTW Room");
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Amend/Error/Accommodation_Amend_Prepay_MultiSupplier/Search-Result-DOTW.jpg");
			errorpath = Config.SnapShotPath()
					+ "/Amend/Error/Accommodation_Amend_Prepay_MultiSupplier/Search-Result-DOTW.jpg";
			logger.info(e.getMessage());
			test.log(LogStatus.FAIL, e.getMessage());
		...
		try {
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Book/Accommodation_Book_Prepay_MultiSupplier/Room-Selection-DOTW.jpg");
			wait.until(
					ExpectedConditions.visibilityOfElementLocated(NewAccoBooking.thirdPartyprocedetoBooksaveoutdead));
			driverqa.findElement(NewAccoBooking.thirdPartyprocedetoBooksaveoutdead).click();
			logger.info("Entering Passenger details");
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Amend/Accommodation_Amend_Prepay_MultiSupplier/Passenger-Details-DOTW.jpg");
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Amend/Accommodation_Amend_Prepay_MultiSupplier/Itenary-Details-DOTW.jpg");
			...
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Amend/Error/Accommodation_Amend_Prepay_MultiSupplier/Save-DOTW.jpg");
			errorpath = Config.SnapShotPath() + "/Amend/Error/Accommodation_Amend_Prepay_MultiSupplier/Save-DOTW.jpg";
			logger.info(e.getMessage());
			test.log(LogStatus.FAIL, e.getMessage());
			rep.endTest(test);
			rep.flush();
		...
		try {
			...
			/*
			 * String actualStartDateDOTW=
			 * driverqa.findElement(MultiAcco.multisupplierSupplierDOTWCheckIn).
			 * getText(); System.out.println(actualStartDateDOTW); String
			 * expectedStartDateDOTW=excel.getData(0, 33, 1); String
			 * actualEndDateDOTW=
			 * driverqa.findElement(MultiAcco.multisupplierSupplierDOTWCheckOut)
			 * .getText(); System.out.println(actualEndDateDOTW); String
			 * expectedEndDateDOTW= excel.getData(, 34, 1); String
			 * actualStartDateSupplier= driverqa.findElement(MultiAcco.
			 * multisupplierSupplierThirdPartyCheckIN).getText();
			 * System.out.println(actualStartDateSupplier); String
			 * expectedStartDateSupplier=excel.getData(3, 28, 1); String
			 * actualEndDateSupplier= driverqa.findElement(MultiAcco.
			 * multisupplierSupplierThirdPartyCheckout).getText();
			 * System.out.println(actualEndDateSupplier); String
			 * expectedEndDateSupplier= excel.getData(3, 29, 1);
			 ...
			 * Assert.assertTrue(actualhoteltitleDOTW.contains(
			 * expectedhoteltitleDOTW));
			 * Assert.assertTrue(actualhoteltitleSupplier.contains(
			 * expectedhoteltitleSupplier));
			 * Assert.assertTrue(actualStartDateDOTW.contains(
			 * expectedStartDateDOTW));
			 * Assert.assertTrue(actualEndDateDOTW.contains(expectedEndDateDOTW)
			 * ); Assert.assertTrue(actualEndDateSupplier.contains(
			 * expectedEndDateSupplier));
			 * Assert.assertTrue(actualStartDateSupplier.contains(
			 * expectedStartDateSupplier));
			 * Assert.assertTrue(actualbookingstatus.contains(
			...
			Assert.assertTrue(actualbookingstatus.contains(expectedbookingstatus1)
					|| actualbookingstatus.contains(expectedbookingstatus2));
			test.log(LogStatus.INFO, "Ending HotelBook Prepay from Saved Itenary Multi Supplier");
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Book/Accommodation_Book_Amend_MultiSupplier/Booking-Details.jpg");
		} catch (Throwable e) {
			test.log(LogStatus.FAIL, "HotelBook Prepay Book from Saved Itenary Multi Supplier");
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Amend/Error/Accommodation_Amend_Prepay_MultiSupplier/Booking-Details.jpg");
			errorpath = Config.SnapShotPath()
					+ "/Amend/Error/Accommodation_Amend_Prepay_MultiSupplier/Booking-Details.jpg";
			logger.info(e.getMessage());
			test.log(LogStatus.FAIL, e.getMessage());
		...
		try {
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Amend/Accommodation_Amend_Prepay_MultiSupplier/booking-Details.jpg");
			 ...
			 * driverqa.findElement(Amend.newFname2).sendKeys(excel.getData(0,
			 * 25, 1));
			...
			/*
			 * logger.info("Adding Supplement");
			 * driverqa.findElement(Amend.AddingSupplementDOTW).click();
			 * 
			 * test.log(LogStatus.PASS, "Supplement added"); logger.info(
			 * "Supplement added");
			 */
			Thread.sleep(3000);
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Amend/Accommodation_Amend_Prepay_MultiSupplier/AmendPage.jpg");
			...
			if (driverqa.findElements(Amend.RatePlanSelect).size() != 0) {
				driverqa.findElement(Amend.RatePlanSelect).click();
			}
			Thread.sleep(3000);
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Amend/Accommodation_Amend_Prepay_MultiSupplier/Confirm-AmendPage.jpg");

			driverqa.findElement(Amend.confirmAmend).click();

			wait.until(ExpectedConditions.visibilityOfElementLocated(Amend.StatusAmend));
			test.log(LogStatus.PASS, "Amend For DOTW Room");
			logger.info("Amended For DOTW Room");
			...
			String newFname = driverqa.findElement(Amend.verifyfNameDOTWrPrePay).getText();
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Amend/Accommodation_Amend_Prepay_MultiSupplier/After-Amend.jpg");
		} catch (Throwable e) {
			test.log(LogStatus.FAIL, "Hotel Amend Prepay for DOTW Room");
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Amend/Error/Accommodation_Amend_Prepay_MultiSupplier/Amend.jpg");
			errorpath = Config.SnapShotPath() + "/Amend/Error/Accommodation_Amend_Prepay_MultiSupplier/Amend.jpg";
			logger.info(e.getMessage());
			test.log(LogStatus.FAIL, e.getMessage());
			rep.endTest(test);
			rep.flush();
