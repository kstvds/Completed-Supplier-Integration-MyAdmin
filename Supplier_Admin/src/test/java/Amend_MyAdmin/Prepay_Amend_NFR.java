...
public class Prepay_Amend_NFR {
	...
	public void BookPrepay(String browsername) throws Exception {
		test = rep.startTest("PrePay Amend NFR");
		...
		try {
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath() + "/Amend/Accommodation_Amend_Prepay_NFR/Log-In.jpg");
		...
		try {
			...
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Amend/Error/Accommodation_Amend_Prepay_NFR/Customer-Search.jpg");
		...
		try {
			...
			obj.Takesnap(driverqa, Config.SnapShotPath() + "/Amend/Accommodation_Amend_Prepay_NFR/Customer-list.jpg");
			...
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Amend/Error/Accommodation_Amend_Prepay_NFR/Customer-list.jpg");
		...
		try {
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Amend/Accommodation_Amend_Prepay_NFR/Search-Hotel-filters.jpg");
			...
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Amend/Accommodation_Amend_Prepay_NFR/Booking-Channel-filters.jpg");
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Amend/Accommodation_Amend_Prepay_NFR/Search-Result-Deadline And NFR.jpg");
			...
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Amend/Error/Accommodation_Amend_Prepay_NFR/Search-Result.jpg");
		...
		try {
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath() + "/Amend/Accommodation_Amend_Prepay_NFR/Room-Selection.jpg");
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Amend/Accommodation_Amend_Prepay_NFR/Passenger-Details.jpg");
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath() + "/Amend/Accommodation_Amend_Prepay_NFR/booking-Details.jpg");
			...
			test.log(LogStatus.INFO, "Ending HotelBook Prepay NFR");
			test.log(LogStatus.PASS, "PASSED HotelBook Prepay NFR");
			logger.info("Hotel Book Complete Prepay NFR");

		} catch (Throwable e) {
			test.log(LogStatus.FAIL, "Hotel Book Prepay NFR");
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Amend/Error/Accommodation_Amend_Prepay_NFR/Unable-To-Book.jpg");
		...
		try {
			...
			test.log(LogStatus.PASS, "PASSED Unable to Amend Prepay NFR");
		} catch (Throwable e) {
			test.log(LogStatus.FAIL, "Hotel Amend Prepay NFR");
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Amend/Error/Accommodation_Amend_Prepay_NFR/Amend-Button-Present.jpg");
