...
public class Book_Credit {
	...
	Logger logger = Logger.getLogger("Book_Credit");
	String SearchRateexpected;
	String errorpath;

	@Test
	@Parameters({ "browsername" })
	public void BookCredit(String browsername) throws Exception {
		...
		try {
			...
			wait.until(ExpectedConditions.visibilityOfElementLocated(NewAccoBooking.thirdPartyafterbookhotelcredit));
			...
			wait.until(ExpectedConditions
					.visibilityOfElementLocated(NewAccoBooking.thirdPartyafterbookCheckInCreditOutDead));
			...
			wait.until(ExpectedConditions
					.visibilityOfElementLocated(NewAccoBooking.thirdPartyafterbookCheckOutCreditOutDead));
