...
public class Book_Credit_Card_Saved_Itenary_NFR {
	...
	public void BookSavedITNCreditCardNFR(String browsername) throws Exception {
		test = rep.startTest("Credit Card Book Saved Ityenary NFR");
		...
		try {
			...
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Book/Accommodation_Book_Credit_Card_Saved_ITN_NFR/Log-In.jpg");

		} catch (Throwable e) {
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Book/Error/Accommodation_Book_Credit_Card_Saved_ITN_NFR/Log-In.jpg");
		...
		try {
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Book/Accommodation_Book_Credit_Card_Saved_ITN_NFR/Customer-Search.jpg");

		} catch (Throwable e) {
			logger.info(e.getMessage());
			test.log(LogStatus.FAIL, "Navigation to customer search page");
			errorpath = Config.SnapShotPath()
					+ "/Book/Error/Accommodation_Book_Credit_Card_Saved_ITN_NFR/Customer-Search.jpg";
			test.log(LogStatus.FAIL, e.getMessage());
			rep.endTest(test);
			rep.flush();
		...
		try {
			...
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Book/Accommodation_Book_Credit_Card_Saved_ITN_NFR/Customer-list.jpg");
			...
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Book/Error/Accommodation_Book_Credit_Card_Saved_ITN_NFR/Customer-list.jpg");
		...
		try {
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Book/Accommodation_Book_Credit_Card_Saved_ITN_NFR/Search-Hotel-filters.jpg");
			...
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Book/Accommodation_Book_Credit_Card_Saved_ITN_NFR/Booking-Channel-filters.jpg");
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Book/Accommodation_Book_Credit_Card_Saved_ITN_NFR/Search-Result.jpg");
			...
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Book/Error/Accommodation_Book_Credit_Card_Saved_ITN_NFR/Search-Result.jpg");
			errorpath = Config.SnapShotPath()
					+ "/Book/Error/Accommodation_Book_Credit_Card_Saved_ITN_NFR/Search-Result.jpg";
			logger.info(e.getMessage());
			test.log(LogStatus.FAIL, e.getMessage());
		...
		try {
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Book/Accommodation_Book_Credit_Card_Saved_ITN_NFR/Room-Selection.jpg");
			wait.until(
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Book/Accommodation_Book_Credit_Card_Saved_ITN_NFR/Passenger-Details.jpg");
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Book/Accommodation_Book_Credit_Card_Saved_ITN_NFR/Itenary-Details.jpg");
			...
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Book/Error/Accommodation_Book_Credit_Card_Saved_ITN_NFR/Save-Itenary.jpg");
			errorpath = Config.SnapShotPath()
					+ "/Book/Error/Accommodation_Book_Credit_Card_Saved_ITN_NFR/Save-Itenary.jpg";
			logger.info(e.getMessage());
			test.log(LogStatus.FAIL, e.getMessage());
		...
		try {
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Book/Accommodation_Book_Credit_Card_Saved_ITN_NFR/Card-Details.jpg");
			...
			test.log(LogStatus.INFO, "Ending HotelBook Credit Card Book from Saved Itenary");
			test.log(LogStatus.PASS, "PASSED HotelBook Credit Card Book from Saved Itenary");
			logger.info("Hotel Book Complete Credit Card Book from Saved Itenary");
			Thread.sleep(2000);
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Book/Accommodation_Book_Credit_Card_Saved_ITN_NFR/Booking-Details.jpg");
		} catch (Throwable e) {
			test.log(LogStatus.FAIL, "Hotel Book from Itenary Credit Card NFR");
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Book/Error/Accommodation_Book_Credit_Card_Saved_ITN_NFR/Booking-Details.jpg");
			errorpath = Config.SnapShotPath()
					+ "/Book/Error/Accommodation_Book_Credit_Card_Saved_ITN_NFR/Booking-Details.jpg";
			logger.info(e.getMessage());
			test.log(LogStatus.FAIL, e.getMessage());
