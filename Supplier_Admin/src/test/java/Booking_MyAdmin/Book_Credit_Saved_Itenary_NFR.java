	...
	public void BookSavedITNCreditNFR(String browsername) throws Exception {
		...
		try {
			...
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Book/Error/Accommodation_Book_Credit_Saved_ITN_NFR/Log-In.jpg");
			test.log(LogStatus.FAIL, "Login");
			errorpath = Config.SnapShotPath() + "/Book/Error/Accommodation_Book_Credit_Saved_ITN_NFR/Log-In.jpg";
		...
		try {
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Book/Accommodation_Book_Credit_Saved_ITN_NFR/Customer-Search.jpg");

		} catch (Throwable e) {
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Book/Error/Accommodation_Book_Credit_Saved_ITN_NFR/Customer-Search.jpg");
			test.log(LogStatus.FAIL, "Navigation to customer search page");
			errorpath = Config.SnapShotPath()
					+ "/Book/Error/Accommodation_Book_Credit_Saved_ITN_NFR/Customer-Search.jpg";
		...
		try {
			...
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Book/Accommodation_Book_Credit_Saved_ITN_NFR/Customer-list.jpg");
			...
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Book/Error/Accommodation_Book_Credit_Saved_ITN_NFR/Customer-list.jpg");
			test.log(LogStatus.FAIL, "Customer Selection");
			errorpath = Config.SnapShotPath() + "/Book/Error/Accommodation_Book_Credit_Saved_ITN_NFR/Customer-list.jpg";
		...
		try {
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Book/Accommodation_Book_Credit_Saved_ITN_NFR/Search-Hotel-filters.jpg");
			...
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Book/Accommodation_Book_Credit_Saved_ITN_NFR/Booking-Channel-filters.jpg");
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Book/Accommodation_Book_Credit_Saved_ITN_NFR/Search-Result.jpg");
			...
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Book/Error/Accommodation_Book_Credit_Saved_ITN_NFR/Search-Result.jpg");
			errorpath = Config.SnapShotPath() + "/Book/Error/Accommodation_Book_Credit_Saved_ITN_NFR/Search-Result.jpg";
			logger.info(e.getMessage());
			test.log(LogStatus.FAIL, e.getMessage());
			rep.endTest(test);
			rep.flush();
		...
		try {
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Book/Accommodation_Book_Credit_Saved_ITN_NFR/Room-Selection.jpg");
			wait.until(
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Book/Accommodation_Book_Credit_Saved_ITN_NFR/Passenger-Details.jpg");
			...
			// driverqa.findElement(NewAccoBooking.thirdPartyaftersaveCheckin).getText();
			// String expectedStartDate=excel.getData(3, 36, 1);
			// String actualEndDate=
			// driverqa.findElement(NewAccoBooking.thirdPartyaftersaveCheckout).getText();
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Book/Accommodation_Book_Credit_Saved_ITN_NFR/Itenary-Details.jpg");
			...
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Book/Error/Accommodation_Book_Credit_Saved_ITN_NFR/Save-Itenary.jpg");
			errorpath = Config.SnapShotPath() + "/Book/Error/Accommodation_Book_Credit_Saved_ITN_NFR/Save-Itenary.jpg";
			logger.info(e.getMessage());
			test.log(LogStatus.FAIL, e.getMessage());
			rep.endTest(test);
			rep.flush();
		...
		try {
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Book/Accommodation_Book_Credit_Saved_ITN_NFR/Booking-Details.jpg");
		} catch (Throwable e) {
			test.log(LogStatus.FAIL, "Hotel Book from Itenary Credit NFR");
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Book/Error/Accommodation_Book_Credit_Saved_ITN_NFR/Booking-Details.jpg");
			errorpath = Config.SnapShotPath()
					+ "/Book/Error/Accommodation_Book_Credit_Saved_ITN_NFR/Booking-Details.jpg";
			logger.info(e.getMessage());
			test.log(LogStatus.FAIL, e.getMessage());
			rep.endTest(test);
			rep.flush();
