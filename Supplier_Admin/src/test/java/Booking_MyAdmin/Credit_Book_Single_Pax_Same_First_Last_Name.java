...
public class Credit_Book_Single_Pax_Same_First_Last_Name {
	...
	Logger logger = Logger.getLogger("Credit_Book_Single_Pax_Same_First_Last_Name");
	...
	public void BookCreditSameFirstLastName(String browsername) throws Exception {
		test = rep.startTest("Credit Book Single PAX with Same First and Last Name");
		...
		try {
			...
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Book/Accommodation_Book_Credit_Single_Pax_Same_First_Last_Name/Log-In.jpg");

		} catch (Throwable e) {
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Book/Error/Accommodation_Book_Credit_Single_Pax_Same_First_Last_Name/Log-In.jpg");
		...
		try {
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Book/Accommodation_Book_Credit_Single_Pax_Same_First_Last_Name/Customer-Search.jpg");

		} catch (Throwable e) {
			test.log(LogStatus.FAIL, "Navigation to customer search page");
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Book/Error/Accommodation_Book_Credit_Single_Pax_Same_First_Last_Name/Customer-Search.jpg");
			errorpath = Config.SnapShotPath()
					+ "/Book/Error/Accommodation_Book_Credit_Single_Pax_Same_First_Last_Name/Customer-Search.jpg";
			logger.info(e.getMessage());
			test.log(LogStatus.FAIL, e.getMessage());
		...
		try {
			...
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Book/Accommodation_Book_Credit_Single_Pax_Same_First_Last_Name/Customer-list.jpg");
			...
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Book/Error/Accommodation_Book_Credit_Single_Pax_Same_First_Last_Name/Customer-list.jpg");
		...
		try {
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Book/Accommodation_Book_Credit_Single_Pax_Same_First_Last_Name/Search-Hotel-filters.jpg");
			...
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Book/Accommodation_Book_Credit_Single_Pax_Same_First_Last_Name/Booking-Channel-filters.jpg");
			...
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Book/Accommodation_Book_Credit_Single_Pax_Same_First_Last_Name/Search-Result.jpg");
			...
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Book/Error/Accommodation_Book_Credit_Single_Pax_Same_First_Last_Name/Search-Result.jpg");
			errorpath = Config.SnapShotPath()
					+ "/Book/Error/Accommodation_Book_Credit_Single_Pax_Same_First_Last_Name/Search-Result.jpg";
			logger.info(e.getMessage());
			test.log(LogStatus.FAIL, e.getMessage());
		...
		try {
			...
			logger.info("Starting Hotel Book Credit Single PAX with Same First and Last Name");
			wait.until(
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Book/Accommodation_Book_Credit_Single_Pax_Same_First_Last_Name/Room-Selection.jpg");
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Book/Accommodation_Book_Credit_Single_Pax_Same_First_Last_Name/Passenger-Details.jpg");
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Book/Accommodation_Book_Credit_Single_Pax_Same_First_Last_Name/booking-Details.jpg");
			...
			test.log(LogStatus.INFO, "Ending HotelBook Credit Single PAX with Same First and Last Name");
			test.log(LogStatus.PASS, "PASSED HotelBook Credit Single PAX with Same First and Last Name");
			logger.info("Hotel Book Complete Credit Single PAX with Same First and Last Name");

		} catch (Throwable e) {
			test.log(LogStatus.FAIL, "Hotel Book Credit Single PAX with Same First and Last Name");
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Book/Error/Accommodation_Book_Credit_Single_Pax_Same_First_Last_Name/Save-Itenary.jpg");
			errorpath = Config.SnapShotPath()
					+ "/Book/Error/Accommodation_Book_Credit_Single_Pax_Same_First_Last_Name/Save-Itenary.jpg";
			logger.info(e.getMessage());
			test.log(LogStatus.FAIL, e.getMessage());
