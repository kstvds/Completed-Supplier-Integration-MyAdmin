...
public class Credit_Card_Book_Single_Pax_Same_First_Last_Name {
	...
	public void BookCreditCardSameFirstLastName(String browsername) throws Exception {
		...
		try {
			...
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Book/Accommodation_Book_Credit_Card_Single_Pax_Same_First_Last_Name/Log-In.jpg");

		} catch (Throwable e) {
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Book/Error/Accommodation_Book_Credit_Card_Single_Pax_Same_First_Last_Name/Log-In.jpg");
		...
		try {
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Book/Accommodation_Book_Credit_Card_Single_Pax_Same_First_Last_Name/Customer-Search.jpg");

		} catch (Throwable e) {
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Book/Error/Accommodation_Book_Credit_Card_Single_Pax_Same_First_Last_Name/Customer-Search.jpg");
		...
		try {
			...
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Book/Accommodation_Book_Credit_Card_Single_Pax_Same_First_Last_Name/Customer-list.jpg");
			...
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Book/Error/Accommodation_Book_Credit_Card_Single_Pax_Same_First_Last_Name/Customer-list.jpg");
		...
		try {
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Book/Accommodation_Book_Credit_Card_Single_Pax_Same_First_Last_Name/Search-Hotel-filters.jpg");
			...
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Book/Accommodation_Book_Credit_Card_Single_Pax_Same_First_Last_Name/Booking-Channel-filters.jpg");
			...
			// SearchRateexpected=
			// driverqa.findElement(NewAccoBooking.thirdPartyaSaveITNSearchrateoutdead).getText();
			// System.out.println(SearchRateexpected);
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Book/Accommodation_Book_Credit_Card_Single_Pax_Same_First_Last_Name/Search-Result.jpg");
			...
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Book/Error/Accommodation_Book_Credit_Card_Single_Pax_Same_First_Last_Name/Search-Result.jpg");
			errorpath = Config.SnapShotPath()
					+ "/Book/Error/Accommodation_Book_Credit_Card_Single_Pax_Same_First_Last_Name/Search-Result.jpg";
			logger.info(e.getMessage());
			test.log(LogStatus.FAIL, e.getMessage());
		...
		try {
			test.log(LogStatus.INFO, "Starting Hotel Book Credit Card Single PAX with Same First and Last Name");
			logger.info("Starting Hotel Book Credit Card Single PAX with Same First and Last Name");
			wait.until(
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Book/Accommodation_Book_Credit_Card_Single_Pax_Same_First_Last_Name/Room-Selection.jpg");
			...
			/*
			 * driverqa.findElement(NewAccoBooking.paxFname2).sendKeys(excel.
			 * getData(0, 14, 0)); Thread.sleep(1000);
			 * driverqa.findElement(NewAccoBooking.paxLname2).sendKeys(excel.
			 * getData(0, 14, 1)); Select passengertitle2 = new
			 * Select(driverqa.findElement(NewAccoBooking.paxtitle2));
			 * passengertitle2.selectByIndex(1);
			 */
			driverqa.findElement(NewAccoBooking.acceptChkBX).click();
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Book/Accommodation_Book_Credit_Card_Single_Pax_Same_First_Last_Name/Passenger-Details.jpg");
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Book/Accommodation_Book_Credit_Card_Single_Pax_Same_First_Last_Name/Proceed-To-Booking.jpg");
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Book/Accommodation_Book_Credit_Card_Single_Pax_Same_First_Last_Name/Card-Details.jpg");
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Book/Accommodation_Book_Credit_Card_Single_Pax_Same_First_Last_Name/booking-Details.jpg");
			...
			String actualStartDate = driverqa.findElement(NewAccoBooking.thirdPartyafterbookCheckInCreditCardOutDead)
					.getText();
			System.out.println(actualStartDate);
			String expectedStartDate = excel.getData(0, 28, 1);
			String actualEndDate = driverqa.findElement(NewAccoBooking.thirdPartyafterbookCheckOutCreditCardOutDead)
					.getText();
			...
			test.log(LogStatus.INFO, "Ending HotelBook Credit Card Single PAX with Same First and Last Name");
			test.log(LogStatus.PASS, "PASSED HotelBook Credit Card Single PAX with Same First and Last Name");
			logger.info("Hotel Book Complete Credit Card Single PAX with Same First and Last Name");

		} catch (Throwable e) {
			test.log(LogStatus.FAIL, "Hotel Book Credit Card Single PAX with Same First and Last Name");
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Book/Error/Accommodation_Book_Credit_Card_Single_Pax_Same_First_Last_Name/Save-Itenary.jpg");
			errorpath = Config.SnapShotPath()
					+ "/Book/Error/Accommodation_Book_Credit_Card_Single_Pax_Same_First_Last_Name/Save-Itenary.jpg";
			logger.info(e.getMessage());
			test.log(LogStatus.FAIL, e.getMessage());
