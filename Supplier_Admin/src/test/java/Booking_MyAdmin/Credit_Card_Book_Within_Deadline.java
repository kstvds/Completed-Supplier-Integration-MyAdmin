...
public class Credit_Card_Book_Within_Deadline {
	...
	public void BookCreditCardWithinDeadLine(String browsername) throws Exception {
		...
		try {
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Book/Accommodation_Book_Credit_Card_Within_DeadLine/Customer-Search.jpg");

		} catch (Throwable e) {

			test.log(LogStatus.FAIL, "Navigation to customer search page");
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Book/Error/Accommodation_Book_Credit_Card_Within_DeadLine/Customer-Search.jpg");
		...
		try {
			...
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Book/Accommodation_Book_Credit_Card_Within_DeadLine/Customer-list.jpg");
			...
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Book/Error/Accommodation_Book_Credit_Card_Within_DeadLine/Customer-list.jpg");
		...
		try {
			...
			/*
			 * Thread.sleep(2000); Select adult2 = new
			 * Select(driverqa.findElement(MultiAcco.adult2));
			 * adult2.selectByIndex(0);
			 */
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Book/Accommodation_Book_Credit_Card_Within_DeadLine/Search-Hotel-filters.jpg");
			...
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Book/Accommodation_Book_Credit_Card_Within_DeadLine/Booking-Channel-filters.jpg");
		...
		try {
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Book/Accommodation_Book_Credit_Card_Within_DeadLine/Room-Selection.jpg");
			...
			if (driverqa.findElements(MultiAcco.paxFname2room1).size() != 0) {
			...
			if (driverqa.findElements(MultiAcco.paxFname3room1).size() != 0) {
			...
			if (driverqa.findElements(MultiAcco.paxFname1room2).size() != 0) {
			...
			if (driverqa.findElements(MultiAcco.paxFname2room2).size() != 0) {
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Book/Accommodation_Book_Credit_Card_Within_DeadLine/Proceed-To-Booking.jpg");
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Book/Accommodation_Book_Credit_Card_Card_Within_DeadLine/Card-Details.jpg");
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Book/Accommodation_Book_Credit_Card_Within_DeadLine/booking-Details.jpg");
