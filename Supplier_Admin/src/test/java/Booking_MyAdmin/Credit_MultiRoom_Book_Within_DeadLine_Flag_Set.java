...
public class Credit_MultiRoom_Book_Within_DeadLine_Flag_Set {
	...
	public void BookCreditMultiRoomwithinDeadlineFlagset(String browsername) throws Exception {
		...
		try {
			...
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Book/Accommodation_Book_Credit_Within_DeadLine_Flag_Set/Log-In.jpg");

		} catch (Throwable e) {
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Book/Error/Accommodation_Book_Credit_Within_DeadLine_Flag_Set/Log-In.jpg");
		...
		try {
			...
			if (elementval.equals("has-switch switch-animate switch-off")) {
				...
				Thread.sleep(2000);
				obj.Takesnap(driverqa, Config.SnapShotPath()
						+ "/Book/Accommodation_Book_Credit_Within_DeadLine_Flag_Set/Before-Flag-Update.jpg");
				driverqa.findElement(Others.Updatechannel).click();
				Thread.sleep(2000);
				obj.Takesnap(driverqa, Config.SnapShotPath()
						+ "/Book/Accommodation_Book_Credit_Within_DeadLine_Flag_Set/Flag-Set.jpg");
			...
			errorpath = Config.SnapShotPath()
					+ "/Book/Error/Accommodation_Book_Credit_Within_DeadLine_Flag_Set/Flag-Setting.jpg";
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Book/Error/Accommodation_Book_Credit_Within_DeadLine_Flag_Set/Flag-Setting.jpg");
			logger.info(e.getMessage());
			test.log(LogStatus.FAIL, e.getMessage());
		...
		try {
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Book/Accommodation_Book_Credit_Within_DeadLine_Flag_Set/Customer-Search.jpg");

		} catch (Throwable e) {
			test.log(LogStatus.FAIL, "Navigation to customer search page");
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Book/Error/Accommodation_Book_Credit_Within_DeadLine_Flag_Set/Customer-Search.jpg");
			errorpath = Config.SnapShotPath()
					+ "/Book/Error/Accommodation_Book_Credit_Within_DeadLine_Flag_Set/Customer-Search.jpg";
			logger.info(e.getMessage());
			test.log(LogStatus.FAIL, e.getMessage());
		...
		try {
			...
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Book/Accommodation_Book_Credit_Within_DeadLine_Flag_Set/Customer-list.jpg");
			...
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Book/Error/Accommodation_Book_Credit_Within_DeadLine_Flag_Set/Customer-list.jpg");
		...
		logger.info("Starting HotelSearch Credit MultiRoom Within DeadLine");
		try {
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Book/Accommodation_Book_Credit_Within_DeadLine_Flag_Set/Search-Hotel-filters.jpg");
			...
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Book/Accommodation_Book_Credit_Within_DeadLine_Flag_Set/Booking-Channel-filters.jpg");
			...
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Book/Accommodation_Book_Credit_Within_DeadLine_Flag_Set/Search-Result.jpg");
			...
			test.log(LogStatus.INFO, "Ending HotelSearch Credit MultiRoom Within DeadLine");
			test.log(LogStatus.PASS, "PASSED HotelSearch Credit MultiRoom Within DeadLine");
			logger.info("Hotel Search Complete Credit MultiRoom Within DeadLine");
		} catch (Throwable e) {
			test.log(LogStatus.FAIL, "Hotel Search Credit MultiRoom Within DeadLine");
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Book/Error/Accommodation_Book_Credit_Within_DeadLine_Flag_Set/Search-Result.jpg");
			errorpath = Config.SnapShotPath()
					+ "/Book/Error/Accommodation_Book_Credit_Within_DeadLine_Flag_Set/Search-Result.jpg";
			logger.info(e.getMessage());
			test.log(LogStatus.FAIL, e.getMessage());
		...
		try {
			test.log(LogStatus.INFO, "Starting Hotel Book Credit MultiRoom Within DeadLine");
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Book/Accommodation_Book_Credit_Within_DeadLine_Flag_Set/Room-Selection.jpg");
			...
			test.log(LogStatus.INFO, "Ending HotelBook Credit MultiRoom Within DeadLine");
			test.log(LogStatus.PASS, "PASSED HotelBook Credit MultiRoom Within DeadLine");
			logger.info("Hotel Book Complete Credit MultiRoom Within DeadLine");
		}

		catch (Throwable e) {
			test.log(LogStatus.FAIL, "Hotel Search Credit");
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Book/Error/Accommodation_Book_Credit_Within_DeadLine_Flag_Set/Booking.jpg");
			errorpath = Config.SnapShotPath()
					+ "/Book/Error/Accommodation_Book_Credit_Within_DeadLine_Flag_Set/Booking.jpg";
			logger.info(e.getMessage());
			test.log(LogStatus.FAIL, e.getMessage());
