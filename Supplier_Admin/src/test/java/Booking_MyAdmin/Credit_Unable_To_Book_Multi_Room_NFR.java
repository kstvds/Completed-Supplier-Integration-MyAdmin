...
public class Credit_Unable_To_Book_Multi_Room_NFR {
	...
	String errorpath;
	 ...
	 @Parameters({ "browsername" })
	  public void BookCreditUnableToBookMultiNFR(String browsername) throws Exception {
		  test = rep.startTest("Credit Unable To Book Multi Room NFR");
		...
		logger.info("Searching Customer");
			 ...
			 try {
				...
				obj.Takesnap(driverqa, Config.SnapShotPath() + "/Book/Accommodation_Book_Credit_Unable_To_Book_MultiRoom_NFR/Customer-list.jpg");
			 ...
			 logger.info("Starting HotelSearch Credit NFR Multirooms");
			 try{
				 test.log(LogStatus.INFO, "Starting HotelSearch Credit NFR Multirooms");
				 ...
				 Thread.sleep(3000);
				 obj.Takesnap(driverqa, Config.SnapShotPath() + "/Book/Accommodation_Book_Credit_Unable_To_Book_MultiRoom_NFR/Search-Hotel-filters.jpg");
				 ...
				 obj.Takesnap(driverqa, Config.SnapShotPath() + "/Book/Accommodation_Book_Credit_Unable_To_Book_MultiRoom_NFR/Booking-Channel-filters.jpg");
				 ...
				 obj.Takesnap(driverqa, Config.SnapShotPath() + "/Book/Accommodation_Book_Credit_Unable_To_Book_MultiRoom_NFR/Search-Result.jpg");
