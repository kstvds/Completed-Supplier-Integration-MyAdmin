...
public class Prepay_Book_Single_Pax_Same_First_Last_Name {
	...
	public void BookPrepaySameFirstLastName(String browsername) throws Exception {
		test = rep.startTest("PrePay Book Single PAX with Same First and Last Name");
		...
		try {
			...
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Book/Accommodation_Book_Prepay_Single_Pax_Same_First_Last_Name/Log-In.jpg");

		} catch (Throwable e) {
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Book/Error/Accommodation_Book_Prepay_Single_Pax_Same_First_Last_Name/Log-In.jpg");
		...
		try {
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Book/Accommodation_Book_Prepay_Single_Pax_Same_First_Last_Name/Customer-Search.jpg");

		} catch (Throwable e) {
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Book/Error/Accommodation_Book_Prepay_Single_Pax_Same_First_Last_Name/Customer-Search.jpg");
		...
		try {
			...
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Book/Accommodation_Book_Prepay_Single_Pax_Same_First_Last_Name/Customer-list.jpg");
			...
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Book/Error/Accommodation_Book_Prepay_Single_Pax_Same_First_Last_Name/Customer-list.jpg");
		...
		try {
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Book/Accommodation_Book_Prepay_Single_Pax_Same_First_Last_Name/Search-Hotel-filters.jpg");
			...
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Book/Accommodation_Book_Prepay_Single_Pax_Same_First_Last_Name/Booking-Channel-filters.jpg");
			...
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Book/Accommodation_Book_Prepay_Single_Pax_Same_First_Last_Name/Search-Result.jpg");
			...
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Book/Error/Accommodation_Book_Prepay_Single_Pax_Same_First_Last_Name/Search-Result.jpg");
			errorpath = Config.SnapShotPath()
					+ "/Book/Error/Accommodation_Book_Prepay_Single_Pax_Same_First_Last_Name/Search-Result.jpg";
			logger.info(e.getMessage());
			test.log(LogStatus.FAIL, e.getMessage());
		...
		try {
			test.log(LogStatus.INFO, "Starting Hotel Book PrePay Single PAX with Same First and Last Name");
			logger.info("Starting Hotel Book PrePay Single PAX with Same First and Last Name");
			wait.until(
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Book/Accommodation_Book_Prepay_Single_Pax_Same_First_Last_Name/Room-Selection.jpg");
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Book/Accommodation_Book_Prepay_Single_Pax_Same_First_Last_Name/Passenger-Details.jpg");
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Book/Accommodation_Book_Prepay_Single_Pax_Same_First_Last_Name/booking-Details.jpg");
			...
			test.log(LogStatus.INFO, "Ending HotelBook Prepay Single PAX with Same First and Last Name");
			test.log(LogStatus.PASS, "PASSED HotelBook Prepay Single PAX with Same First and Last Name");
			logger.info("Hotel Book Complete Prepay Single PAX with Same First and Last Name");

		} catch (Throwable e) {
			test.log(LogStatus.FAIL, "Hotel Book Prepay Single PAX with Same First and Last Name");
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Book/Error/Accommodation_Book_Prepay_Single_Pax_Same_First_Last_Name/Booking.jpg");
			errorpath = Config.SnapShotPath()
					+ "/Book/Error/Accommodation_Book_Prepay_Single_Pax_Same_First_Last_Name/Booking.jpg";
			logger.info(e.getMessage());
			test.log(LogStatus.FAIL, e.getMessage());
