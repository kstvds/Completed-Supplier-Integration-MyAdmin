...
public class Prepay_Unable_To_Book_Multi_Room_NFR {
	...
	String errorpath;
	 ...
	 @Parameters({ "browsername" })
	  public void BookPrepayUnableToBookMultiNFR(String browsername) throws Exception {
		  test = rep.startTest("PrePay Unable To Book Multi Room NFR");
		...
		logger.info("Searching Customer");
			 ...
			 try {
				...
				obj.Takesnap(driverqa, Config.SnapShotPath() + "/Book/Accommodation_Book_Prepay_Unable_To_Book_MultiRoom_NFR/Customer-list.jpg");
			 ...
			 logger.info("Starting HotelSearch Prepay NFR Multirooms");
			 try{
				 test.log(LogStatus.INFO, "Starting HotelSearch Prepay NFR Multirooms");
				 ...
				 Thread.sleep(3000);
				 obj.Takesnap(driverqa, Config.SnapShotPath() + "/Book/Accommodation_Book_Prepay_Unable_To_Book_MultiRoom_NFR/Search-Hotel-filters.jpg");
				 ...
				 obj.Takesnap(driverqa, Config.SnapShotPath() + "/Book/Accommodation_Book_Prepay_Unable_To_Book_MultiRoom_NFR/Booking-Channel-filters.jpg");
				 ...
				 obj.Takesnap(driverqa, Config.SnapShotPath() + "/Book/Accommodation_Book_Prepay_Unable_To_Book_MultiRoom_NFR/Search-Result.jpg");
