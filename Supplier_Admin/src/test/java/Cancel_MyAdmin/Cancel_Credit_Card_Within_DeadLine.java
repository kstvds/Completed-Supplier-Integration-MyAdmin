...
public class Cancel_Credit_Card_Within_DeadLine {
	...
	public void CancelCreditCardWithinDeadLine(String browsername) throws Exception {
		...
		try {
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Cancel/Accommodation_Cancel_Credit_Card_Within_DeadLine/Customer-Search.jpg");

		} catch (Throwable e) {
			test.log(LogStatus.FAIL, "Navigation to customer search page");
			errorpath = Config.SnapShotPath()
					+ "/Cancel/Error/Accommodation_Cancel_Credit_Card_Within_DeadLine/Customer-Search.jpg";
			logger.info(e.getMessage());
			test.log(LogStatus.FAIL, e.getMessage());
			rep.endTest(test);
			rep.flush();
		...
		try {
			...
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Cancel/Accommodation_Cancel_Credit_Card_Within_DeadLine/Customer-list.jpg");
			...
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Cancel/Error/Accommodation_Cancel_Credit_Card_Within_DeadLine/Customer-list.jpg");
		...
		try {
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Cancel/Accommodation_Cancel_Credit_Card_Within_DeadLine/Search-Hotel-filters.jpg");
			...
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Cancel/Accommodation_Cancel_Credit_Card_Within_DeadLine/Booking-Channel-filters.jpg");
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Cancel/Accommodation_Cancel_Credit_Card_Within_Deadline/Search-Result_Deadline.jpg");
		...
		try {
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Cancel/Accommodation_Cancel_Credit_Card_Within_DeadLine/Room-Selection.jpg");
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Cancel/Accommodation_Cancel_Credit_Card_Within_DeadLine/Proceed-To-Booking.jpg");
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Cancel/Accommodation_Cancel_Credit_Card_Within_DeadLine/Card-Details.jpg");
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Cancel/Accommodation_Cancel_Credit_Card_Within_DeadLine/booking-Details.jpg");
		...
		try {
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Cancel/Accommodation_Cancel_Credit_Card_Within_DeadLine/Proceed-To-Cancellation.jpg");
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Cancel/Accommodation_Cancel_Credit_Card_Within_DeadLine/Confirm-Cancellation.jpg");
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Cancel/Accommodation_Cancel_Credit_Card_Within_DeadLine/After-Cancel.jpg");
