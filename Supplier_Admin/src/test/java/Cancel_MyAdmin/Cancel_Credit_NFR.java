...
public class Cancel_Credit_NFR {
	...
	public void CancelCreditNFR(String browsername) throws Exception {
		test = rep.startTest("Credit Cancel NFR");
		...
		try {
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath() + "/Cancel/Accommodation_Cancel_Credit_NFR/Log-In.jpg");
		...
		try {
			...
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Cancel/Accommodation_Cancel_Credit_NFR/Customer-Search.jpg");

		} catch (Throwable e) {
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Cancel/Error/Accommodation_Cancel_Credit_NFR/Customer-Search.jpg");
		...
		try {
			...
			obj.Takesnap(driverqa, Config.SnapShotPath() + "/Cancel/Accommodation_Cancel_Credit_NFR/Customer-list.jpg");
			...
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Cancel/Error/Accommodation_Cancel_Credit_NFR/Customer-list.jpg");
		...
		try {
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Cancel/Accommodation_Cancel_Credit_NFR/Search-Hotel-filters.jpg");
			...
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Cancel/Accommodation_Cancel_Credit_NFR/Booking-Channel-filters.jpg");
			...
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Cancel/Accommodation_Cancel_Credit_NFR/Search-Result-Deadline And NFR.jpg");
			...
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Cancel/Error/Accommodation_Cancel_Credit_NFR/Search-Result.jpg");
		...
		try {
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Cancel/Accommodation_Cancel_Credit_NFR/Room-Selection.jpg");
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Cancel/Accommodation_Cancel_Credit_NFR/Passenger-Details.jpg");
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Cancel/Accommodation_Cancel_Credit_NFR/booking-Details.jpg");
			...
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Cancel/Error/Accommodation_Cancel_Credit_NFR/Unable-To-Book.jpg");
		...
		try {
			...
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Cancel/Error/Accommodation_Cancel_Credit_NFR/Cancel-Button-Present.jpg");
			errorpath = Config.SnapShotPath()
					+ "/Cancel/Error/Accommodation_Cancel_Credit_NFR/Cancel-Button-Present.jpg";
			logger.info(e.getMessage());
			test.log(LogStatus.FAIL, e.getMessage());
			rep.endTest(test);
			rep.flush();
