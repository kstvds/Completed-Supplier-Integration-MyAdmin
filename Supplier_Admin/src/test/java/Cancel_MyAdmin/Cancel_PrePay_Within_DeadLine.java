...
public class Cancel_PrePay_Within_DeadLine {
	...
	public void CancelPrepayWithinDeadLine(String browsername) throws Exception {
		test = rep.startTest("Cancel Prepay Within DeadLine");
		...
		try {
			...
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Cancel/Accommodation_Cancel_Prepay_Within_DeadLine/Log-In.jpg");

		} catch (Throwable e) {

			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Cancel/Error/Accommodation_Cancel_Prepay_Within_DeadLine/Log-In.jpg");
			errorpath = Config.SnapShotPath() + "/Cancel/Error/Accommodation_Cancel_Prepay_Within_DeadLine/Log-In.jpg";
		...
		try {
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Cancel/Accommodation_Cancel_Prepay_Within_DeadLine/Customer-Search.jpg");
			...
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Cancel/Error/Accommodation_Cancel_Prepay_Within_DeadLine/Customer-Search.jpg");
		...
		try {
			...
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Cancel/Accommodation_Cancel_Prepay_Within_DeadLine/Customer-list.jpg");
			...
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Cancel/Error/Accommodation_Cancel_Prepay_Within_DeadLine/Customer-list.jpg");
			errorpath = Config.SnapShotPath()
					+ "/Cancel/Error/Accommodation_Cancel_Prepay_Within_DeadLine/Customer-list.jpg";
		...
		try {
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Cancel/Accommodation_Cancel_Prepay_Within_DeadLine/Search-Hotel-filters.jpg");
			...
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Cancel/Accommodation_Cancel_Prepay_Within_DeadLine/Booking-Channel-filters.jpg");
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Cancel/Accommodation_Cancel_Prepay_Within_Deadline/Search-Result_Deadline.jpg");
			...
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Cancel/Error/Accommodation_Cancel_Prepay_Within_DeadLine/Search-Result.jpg");
			errorpath = Config.SnapShotPath()
					+ "/Cancel/Error/Accommodation_Cancel_Prepay_Within_DeadLine/Search-Result.jpg";
			logger.info(e.getMessage());
			test.log(LogStatus.FAIL, e.getMessage());
		...
		try {
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Cancel/Accommodation_Cancel_Prepay_Within_DeadLine/Room-Selection.jpg");
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Cancel/Accommodation_Cancel_Prepay_Within_DeadLine/Passenger-Details.jpg");
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Cancel/Accommodation_Cancel_Prepay_Within_DeadLine/booking-Details.jpg");
			...
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Cancel/Error/Accommodation_Cancel_Prepay_Within_DeadLine/booking.jpg");
			errorpath = Config.SnapShotPath() + "/Cancel/Error/Accommodation_Cancel_Prepay_Within_DeadLine/booking.jpg";
			logger.info(e.getMessage());
			test.log(LogStatus.FAIL, e.getMessage());
			rep.endTest(test);
			rep.flush();
		...
		try {
			test.log(LogStatus.INFO, "Starting to Cancel PrePay Within DeadLine");
			logger.info("Starting to Cancel PrePay Within DeadLine");
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Cancel/Accommodation_Cancel_Prepay_Within_DeadLine/Proceed-To-Cancellation.jpg");
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Cancel/Accommodation_Cancel_Prepay_Within_DeadLine/Confirm-Cancellation.jpg");
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Cancel/Accommodation_Cancel_Prepay_Within_DeadLine/After-Cancel.jpg");
			test.log(LogStatus.PASS, "Cancellation PrePay Within DeadLine");
			logger.info("Completed Cancellation PrePay Within DeadLine");

		} catch (Throwable e) {
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Cancel/Error/Accommodation_Cancel_Prepay_Within_DeadLine/Cancel.jpg");
			errorpath = Config.SnapShotPath() + "/Cancel/Error/Accommodation_Cancel_Prepay_Within_DeadLine/Cancel.jpg";
			logger.info(e.getMessage());
			test.log(LogStatus.FAIL, e.getMessage());
			rep.endTest(test);
			rep.flush();
