...
public class Save_Credit_NFR {
	...
	Logger logger = Logger.getLogger("Save_Credit_NFR");
	String errorpath;

	@Test
	@Parameters({ "browsername" })
	public void SaveCreditNFR(String browsername) throws Exception {
		...
		try {
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath() + "/Save/Accommodation_Save_Credit_NFR/Customer-Search.jpg");

		} catch (Throwable e) {
			test.log(LogStatus.FAIL, "Navigation to customer search page");
			errorpath = Config.SnapShotPath() + "/Save/Error/Accommodation_Save_Credit_NFR/Customer-Search.jpg";
			logger.info(e.getMessage());
			test.log(LogStatus.FAIL, e.getMessage());
			rep.endTest(test);
			rep.flush();
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Save/Error/Accommodation_Save_Credit_NFR/Customer-Search.jpg");
			Assert.assertTrue(false, e.getMessage());
		...
		try {
			...
			obj.Takesnap(driverqa, Config.SnapShotPath() + "/Save/Accommodation_Save_Credit_NFR/Customer-list.jpg");
			...
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Save/Error/Accommodation_Save_Credit_NFR/Customer-list.jpg");
			test.log(LogStatus.FAIL, "Customer Selection");
			errorpath = Config.SnapShotPath() + "/Save/Error/Accommodation_Save_Credit_NFR/Customer-list.jpg";
		...
		try {
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Save/Accommodation_Save_Credit_NFR/Search-Hotel-filters.jpg");
			...
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Save/Accommodation_Save_Credit_NFR/Booking-Channel-filters.jpg");
			...
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Save/Error/Accommodation_Save_Credit_NFR/Search-Result.jpg");
		...
		try {
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath() + "/Save/Accommodation_Save_Credit_NFR/Room-Selection.jpg");
			wait.until(
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath() + "/Save/Accommodation_Save_Credit_NFR/Itenary-Details.jpg");
			...
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Save/Error/Accommodation_Save_Credit_NFR/Save-Itenary.jpg");
			errorpath = Config.SnapShotPath() + "/Save/Error/Accommodation_Save_Credit_NFR/Save-Itenary.jpg";
			logger.info(e.getMessage());
			test.log(LogStatus.FAIL, e.getMessage());
			rep.endTest(test);
			rep.flush();
		...
		try {
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Save/Accommodation_Save_Credit_NFR/Confirm-Delete-Itenary-Details.jpg");
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Save/Accommodation_Save_Credit_NFR/Deleted-Itenary-Details.jpg");
			...
			test.log(LogStatus.FAIL, "Hotel Delete from Itenary Credit NFR");
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Save/Error/Accommodation_Save_Credit_NFR/Delete-Itenary.jpg");
			errorpath = Config.SnapShotPath() + "/Save/Error/Accommodation_Save_Credit_NFR/Delete-Itenary.jpg";
			logger.info(e.getMessage());
			test.log(LogStatus.FAIL, e.getMessage());
			rep.endTest(test);
			rep.flush();
