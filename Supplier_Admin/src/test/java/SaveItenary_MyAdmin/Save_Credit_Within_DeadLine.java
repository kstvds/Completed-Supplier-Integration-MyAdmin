...
public class Save_Credit_Within_DeadLine {
	...
	Logger logger = Logger.getLogger("Save_Credit_Within_DeadLine");
	//String SearchRateexpected;
	String errorpath;
	 @Test
	 @Parameters({ "browsername" })
	  public void SaveCreditWithinDeadLine(String browsername) throws Exception {
		  test = rep.startTest("Credit Save Within Deadline");
		...
		logger.info("Searching Customer");
		     ...
		     try {
				...
				rep.endTest(test);
				rep.flush();
				obj.Takesnap(driverqa, Config.SnapShotPath() + "/Save/Error/Accommodation_Save_Credit_Within_DeadLine/Customer-Search.jpg");
				Assert.assertTrue(false, e.getMessage());
			 ...
			 try {
				...
				obj.Takesnap(driverqa, Config.SnapShotPath() + "/Save/Accommodation_Save_Credit_Within_DeadLine/Customer-list.jpg");
			 ...
			 try{
				 ...
				 Thread.sleep(2000);
				 obj.Takesnap(driverqa, Config.SnapShotPath() + "/Save/Accommodation_Save_Credit_Within_DeadLine/Search-Hotel-filters.jpg");
				 ...
				 obj.Takesnap(driverqa, Config.SnapShotPath() + "/Save/Accommodation_Save_Credit_Within_DeadLine/Booking-Channel-filters.jpg");
				 ...
				 Thread.sleep(2000);
				 obj.Takesnap(driverqa, Config.SnapShotPath() + "/Save/Accommodation_Save_Credit_Within_DeadLine/Search-Result.jpg");
				...
				try {
					test.log(LogStatus.INFO, "Starting Hotel Save Itenary Credit");
					 logger.info("Starting Hotel Save Credit");
					 ...
					 Thread.sleep(2000);
					 obj.Takesnap(driverqa, Config.SnapShotPath() + "/Save/Accommodation_Save_Credit_Within_DeadLine/Room-Selection.jpg");
					...
					Thread.sleep(2000);
					obj.Takesnap(driverqa, Config.SnapShotPath() + "/Save/Accommodation_Save_Credit_Within_DeadLine/Itenary-Details.jpg");
					test.log(LogStatus.INFO, "Ending HotelSave Credit");
				    ...
				    try {
						...
						Thread.sleep(2000);
						obj.Takesnap(driverqa, Config.SnapShotPath() + "/Save/Accommodation_Save_Credit_Within_DeadLine/Confirm-Delete-Itenary-Details.jpg");
						...
						Thread.sleep(2000);
						obj.Takesnap(driverqa, Config.SnapShotPath() + "/Save/Accommodation_Save_Credit_Within_DeadLine/Deleted-Itenary-Details.jpg");
