...
public class Save_Prepay_MultiSupplier {
	...
	Logger logger = Logger.getLogger("Save_Prepay_MultiSupplier");
	String SearchRateexpected;
	String errorpath;

	@Test
	@Parameters({ "browsername" })
	public void SavePrepayMultiSupplier(String browsername) throws Exception {
		test = rep.startTest("Save Prepay MultiSupplier");
		...
		try {
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath() + "/Save/Accommodation_Save_Prepay_MultiSupplier/Log-In.jpg");

		} catch (Throwable e) {
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Save/Error/Accommodation_Save_Prepay_MultiSupplier/Log-In.jpg");
			test.log(LogStatus.FAIL, "Login");
			errorpath = Config.SnapShotPath() + "/Save/Error/Accommodation_Save_Prepay_MultiSupplier/Log-In.jpg";
		...
		try {
			...
			Thread.sleep(3000);
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Save/Accommodation_Save_Prepay_MultiSupplier/Customer-Search.jpg");

		} catch (Throwable e) {
			test.log(LogStatus.FAIL, "Navigation to customer search page");
			errorpath = Config.SnapShotPath()
					+ "/Save/Error/Accommodation_Save_Prepay_MultiSupplier/Customer-Search.jpg";
			...
			rep.flush();
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Save/Error/Accommodation_Save_Prepay_MultiSupplier/Customer-Search.jpg");
			Assert.assertTrue(false, e.getMessage());
		}
		...
		try {
			...
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Save/Accommodation_Save_Prepay_MultiSupplier/Customer-list.jpg");
			...
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Save/Error/Accommodation_Save_Prepay_MultiSupplier/Customer-list.jpg");
			test.log(LogStatus.FAIL, "Customer Selection");
			errorpath = Config.SnapShotPath() + "/Save/Error/Accommodation_Save_Prepay_MultiSupplier/Customer-list.jpg";
		...
		try {
			...
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Save/Accommodation_Save_Prepay_MultiSupplier/Search-Hotel-Supplier-filters.jpg");
			...
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Save/Accommodation_Save_Prepay_MultiSupplier/Booking-Channel-Supplier-filters.jpg");
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Save/Accommodation_Save_Prepay_MultiSupplier/Search-Result-Supplier.jpg");
			...
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Save/Error/Accommodation_Save_Prepay_MultiSupplier/Search-Result-Supplier.jpg");
			errorpath = Config.SnapShotPath()
					+ "/Save/Error/Accommodation_Save_Prepay_MultiSupplier/Search-Result-Supplier.jpg";
		...
		try {
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Save/Accommodation_Save_Prepay_MultiSupplier/Room-Selection-Supplier.jpg");
			wait.until(
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Save/Accommodation_Save_Prepay_MultiSupplier/Passenger-Details-Supplier.jpg");
			...
			// String actualRate=
			// driverqa.findElement(NewAccoBooking.thirdPartyaSaveITNrateoutdead).getText();
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Save/Accommodation_Save_Prepay_MultiSupplier/Itenary-Details-Supplier.jpg");
			...
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Save/Error/Accommodation_Save_Prepay_MultiSupplier/Save-Itenary-Supplier.jpg");
			errorpath = Config.SnapShotPath()
					+ "/Save/Error/Accommodation_Save_Prepay_MultiSupplier/Save-Itenary-Supplier.jpg";
			logger.info(e.getMessage());
			test.log(LogStatus.FAIL, e.getMessage());
		...
		try {
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Save/Accommodation_Save_Prepay_MultiSupplier/Search-Hotel-filters-DOTW.jpg");
			wait.until(ExpectedConditions.visibilityOfElementLocated(NewAccoBooking.bookChannel));
			driverqa.findElement(NewAccoBooking.bookChannel).click();
			...
			wait.until(ExpectedConditions.visibilityOfElementLocated(NewAccoBooking.searchButton));
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Save/Accommodation_Save_Prepay_MultiSupplier/Booking-Channel-filters-DOTW.jpg");
			driverqa.findElement(NewAccoBooking.searchButton).click();
			wait.until(ExpectedConditions.visibilityOfElementLocated(NewAccoBooking.thirdPartyresultHotel));
			String result = driverqa.findElement(NewAccoBooking.thirdPartyresultHotel).getText();
			Thread.sleep(2000);
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Save/Accommodation_Save_Prepay_MultiSupplier/Search-Result-DOTW.jpg");
			Assert.assertTrue(result.contains(expected));
			...
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Save/Error/Accommodation_Save_Prepay_MultiSupplier/Search-Result-DOTW.jpg");
			errorpath = Config.SnapShotPath()
					+ "/Save/Error/Accommodation_Save_Prepay_MultiSupplier/Search-Result-DOTW.jpg";
		...
		try {
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Save/Accommodation_Save_Prepay_MultiSupplier/Room-Selection-DOTW.jpg");
			wait.until(
					ExpectedConditions.visibilityOfElementLocated(NewAccoBooking.thirdPartyprocedetoBooksaveoutdead));
			driverqa.findElement(NewAccoBooking.thirdPartyprocedetoBooksaveoutdead).click();
			logger.info("Entering Passenger details");
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Save/Accommodation_Save_Prepay_MultiSupplier/Passenger-Details-DOTW.jpg");
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Save/Accommodation_Save_Prepay_MultiSupplier/Itenary-Details-DOTW.jpg");
			...
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Save/Error/Accommodation_Save_Prepay_MultiSupplier/Itenary-Details-DOTW.jpg");
			errorpath = Config.SnapShotPath()
					+ "/Save/Error/Accommodation_Save_Prepay_MultiSupplier/Itenary-Details-DOTW.jpg";
		...
		try {
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Save/Accommodation_Save_Prepay_MultiSupplier/Confirm-Delete-1st-Itenary-Details.jpg");
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Save/Accommodation_Save_Prepay_MultiSupplier/Deleted-1st-Itenary-Details.jpg");
			...
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Save/Error/Accommodation_Save_Prepay_MultiSupplier/Delete-1st-Itenary.jpg");
			errorpath = Config.SnapShotPath()
					+ "/Save/Error/Accommodation_Save_Prepay_MultiSupplier/Delete-1st-Itenary.jpg";
			logger.info(e.getMessage());
			test.log(LogStatus.FAIL, e.getMessage());
		...
		try {
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Save/Accommodation_Save_Prepay_MultiSupplier/Confirm-Delete-2nd-Itenary-Details.jpg");
			wait.until(ExpectedConditions.visibilityOfElementLocated(NewAccoBooking.thirdPartyconfirmremovefromcart));
			driverqa.findElement(NewAccoBooking.thirdPartyconfirmremovefromcart).click();
			wait.until(
					ExpectedConditions.visibilityOfElementLocated(NewAccoBooking.thirdPartyremovefromcartconfirmtext));
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Save/Accommodation_Save_Prepay_MultiSupplier/Deleted-2nd-Itenary-Details.jpg");
			String Deletesuccesstext = driverqa.findElement(NewAccoBooking.thirdPartyremovefromcartconfirmtext)
					.getText();
			String expectedDeletesuccesstext = excel.getData(0, 31, 1);
			System.out.println(Deletesuccesstext);
			...
			Thread.sleep(3000);
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Save/Accommodation_Save_Prepay_MultiSupplier/Deleted-full-itenary.jpg");
			...
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Save/Error/Accommodation_Save_Prepay_MultiSupplier/Delete-2nd-Itenary.jpg");
			errorpath = Config.SnapShotPath()
					+ "/Save/Error/Accommodation_Save_Prepay_MultiSupplier/Delete-2nd-Itenary.jpg";
		}
