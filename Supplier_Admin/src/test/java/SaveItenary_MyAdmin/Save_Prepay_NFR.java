...
public class Save_Prepay_NFR {
	...
	Logger logger = Logger.getLogger("Save_Prepay_NFR");
	String SearchRateexpected;
	String errorpath;

	@Test
	@Parameters({ "browsername" })
	public void SavePrepayNFR(String browsername) throws Exception {
		test = rep.startTest("PrePay Save NFR");
		...
		try {
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath() + "/Save/Accommodation_Save_Prepay_NFR/Log-In.jpg");

		} catch (Throwable e) {
			obj.Takesnap(driverqa, Config.SnapShotPath() + "/Save/Error/Accommodation_Save_Prepay_NFR/Log-In.jpg");
			test.log(LogStatus.FAIL, "Login");
			errorpath = Config.SnapShotPath() + "/Save/Error/Accommodation_Save_Prepay_NFR/Log-In.jpg";
		...
		try {
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath() + "/Save/Accommodation_Save_Prepay_NFR/Customer-Search.jpg");

		} catch (Throwable e) {
			test.log(LogStatus.FAIL, "Navigation to customer search page");
			errorpath = Config.SnapShotPath() + "/Save/Error/Accommodation_Save_Prepay_NFR/Customer-Search.jpg";
			logger.info(e.getMessage());
			test.log(LogStatus.FAIL, e.getMessage());
			rep.endTest(test);
			rep.flush();
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Save/Error/Accommodation_Save_Prepay_NFR/Customer-Search.jpg");
			Assert.assertTrue(false, e.getMessage());
		...
		try {
			...
			obj.Takesnap(driverqa, Config.SnapShotPath() + "/Save/Accommodation_Save_Prepay_NFR/Customer-list.jpg");
			...
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Save/Error/Accommodation_Save_Prepay_NFR/Customer-list.jpg");
			test.log(LogStatus.FAIL, "Customer Selection");
			errorpath = Config.SnapShotPath() + "/Save/Error/Accommodation_Save_Prepay_NFR/Customer-list.jpg";
			logger.info(e.getMessage());
			test.log(LogStatus.FAIL, e.getMessage());
			rep.endTest(test);
			rep.flush();
		...
		try {
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Save/Accommodation_Save_Prepay_NFR/Search-Hotel-filters.jpg");
			...
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Save/Accommodation_Save_Prepay_NFR/Booking-Channel-filters.jpg");
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath() + "/Save/Accommodation_Save_Prepay_NFR/Search-Result.jpg");
			...
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Save/Error/Accommodation_Save_Prepay_NFR/Search-Result.jpg");
			errorpath = Config.SnapShotPath() + "/Save/Error/Accommodation_Save_Prepay_NFR/Search-Result.jpg";
			logger.info(e.getMessage());
			test.log(LogStatus.FAIL, e.getMessage());
			rep.endTest(test);
			rep.flush();
		...
		try {
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath() + "/Save/Accommodation_Save_Prepay_NFR/Room-Selection.jpg");
			wait.until(
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath() + "/Save/Accommodation_Save_Prepay_NFR/Passenger-Details.jpg");
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath() + "/Save/Accommodation_Save_Prepay_NFR/Itenary-Details.jpg");
			...
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Save/Error/Accommodation_Save_Prepay_NFR/Save-Itenary.jpg");
			errorpath = Config.SnapShotPath() + "/Save/Error/Accommodation_Save_Prepay_NFR/Save-Itenary.jpg";
			logger.info(e.getMessage());
			test.log(LogStatus.FAIL, e.getMessage());
			rep.endTest(test);
			rep.flush();
		...
		try {
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Save/Accommodation_Save_Prepay_NFR/Confirm-Delete-Itenary-Details.jpg");
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Save/Accommodation_Save_Prepay_NFR/Deleted-Itenary-Details.jpg");
			...
			test.log(LogStatus.FAIL, "Hotel Delete from Itenary Prepay NFR");
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Save/Error/Accommodation_Save_Prepay_NFR/Delete-Itenary.jpg");
			errorpath = Config.SnapShotPath() + "/Save/Error/Accommodation_Save_Prepay_NFR/Delete-Itenary.jpg";
			logger.info(e.getMessage());
			test.log(LogStatus.FAIL, e.getMessage());
			rep.endTest(test);
			rep.flush();
