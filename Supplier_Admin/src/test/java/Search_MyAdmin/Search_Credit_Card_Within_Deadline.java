...
/* #######  Test for accommodation Search for Credit Card user within Deadline #########
	...
	public void SearchCreditCardWithinDeadline(String browsername) throws Exception {
		...
		try {
			...
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Search/Accommodation_Search_Credit_Card_Within_Deadline/Log-In.jpg");

		} catch (Throwable e) {
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Search/Error/Accommodation_Search_Credit_Card_Within_Deadline/Log-In.jpg");
		...
		try {
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Search/Accommodation_Search_Credit_Card_Within_Deadline/Customer-Search.jpg");
			...
			rep.flush();
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Search/Error/Accommodation_Search_Credit_Card_Within_Deadline/Customer-Search.jpg");
		...
		try {
			...
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Search/Accommodation_Search_Credit_Card_Within_Deadline/Customer-list.jpg");
			...
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Search/Error/Accommodation_Search_Credit_Card_Within_Deadline/Customer-list.jpg");
			errorpath = Config.SnapShotPath()
					+ "/Search/Error/Accommodation_Search_Credit_Card_Within_Deadline/Customer-lis.jpg";
		...
		try {
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Search/Accommodation_Search_Credit_Card_Within_Deadline/Search-Hotel-filters.jpg");
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Search/Accommodation_Search_Credit_Card_Within_Deadline/Booking-Channel-filters.jpg");
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Search/Accommodation_Search_Credit_Card_Within_Deadline/Search-Result.jpg");
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Search/Accommodation_Search_Credit_Card_Within_Deadline/Search-Result_Deadline.jpg");
